...
func (s *EmailService) SendRoleChangeNotification(user *entities.User, newRole string) error {
	template := GetRoleChangeNotificationTemplate()
	data := PrepareTemplateData(user, nil, nil, newRole)
