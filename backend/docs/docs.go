...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/audit-logs/action/{action}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Ação para filtrar (ex: CREATE, UPDATE, DELETE, LOGIN)",
                        "name": "action",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "Lista de logs de auditoria por ação",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/audit-logs/activity/user/{user_id}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/audit-logs/cleanup": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dias de retenção inválido",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/audit-logs/date-range": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Lista de logs de auditoria por período",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Datas obrigatórias ou formato inválido",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/audit-logs/reports/active-users": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/audit-logs/reports/common-actions": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "Lista de ações mais comuns",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/audit-logs/resource/{resource}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Recurso para filtrar (ex: USER, BOOKING, CHAIR, AVAILABILITY)",
                        "name": "resource",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "Lista de logs de auditoria por recurso",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Recurso obrigatório",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/availabilities": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filtrar por dia da semana (0-6)",
                        "name": "day_of_week",
                        "in": "query"
                    },
                    {
        ...
        "/availabilities/chair/{chair_id}/available-slots": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateBookingRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateBookingResponse"
                        }
                    },
                    "400": {
                        "description": "Dados inválidos",
        ...
        "/bookings/attendant-stats": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Estatísticas do atendente",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/bookings/chair/{chair_id}/date/{date}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "Lista de agendamentos da cadeira na data",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/bookings/date/{date}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Lista de agendamentos da data",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/bookings/user-stats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID do usuário (opcional, usa usuário logado se não informado)",
                        "name": "user_id",
                        "in": "query"
                    }
                ],
        ...
        "/chairs/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Lista de cadeiras ativas",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/chairs/available": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Lista de cadeiras disponíveis",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Erro ao buscar cadeiras",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/chairs/stats": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Estatísticas das cadeiras",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/dashboard/sessions/date/{date}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Data para buscar sessões (formato: YYYY-MM-DD)",
                        "name": "date",
                        "in": "path",
                        "required": true
                    }
        ...
        "/dashboard/stats/attendance": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Estatísticas de comparecimento",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "handlers.LoginRequest": {
            ...
            "properties": {
                "cpf": {
                    "description": "CPF do usuário (apenas números, pontos e hífen serão removidos automaticamente)\nrequired: true\nexample: \"123.456.789-09\"",
                    "type": "string"
                },
                "password": {
        ...
        "handlers.LoginResponse": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "description": "Refresh token para renovar o token principal (válido por 7 dias)\nexample: \"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...\"",
                    "type": "string"
                },
                "token": {
                    "description": "Token JWT para autenticação (válido por 24 horas)\nexample: \"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...\"",
                    "type": "string"
                },
                "user": {
        ...
        "handlers.RegisterRequest": {
            ...
            "properties": {
                ...
                "position": {
                    "description": "Posição hierárquica\nrequired: true\nexample: \"Junior\"",
                    "type": "string"
                },
                "registration": {
                ...
                "requested_role": {
                    "description": "Role solicitado pelo usuário\nrequired: true\nenum: usuario,atendente,admin\nexample: \"usuario\"",
                    "type": "string",
                    "enum": [
                        "usuario",
                        "atendente",
        ...
        "handlers.RegisterResponse": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "Role atribuído (sempre \"usuario\" para novos registros)\nexample: \"usuario\"",
                    "type": "string"
                },
                "status": {
                    "description": "Status do usuário (sempre \"pendente\" para novos registros)\nexample: \"pendente\"",
                    "type": "string"
                }
            }
        }
